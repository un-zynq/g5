!function(t, e) {
    ...
    class m extends n {
        ...
        _skinLoaded() {
            this.slider && (this.slider.skin = this._skin, this.callLater(this.changeScrollBar), 
            this._sizeChanged(), this.event(e.Event.LOADED));
        }
        changeScrollBar() {
    ...
    class w extends n {
        ...
        _skinLoaded() {
            this._bg && (this._bg.skin = this._skin, this._bar.skin = this._skin.replace(".png", "$bar.png"), 
